package com.app.postapi.Loaders;
...
//import com.app.isafe.Utils.AppData;


public class JSONFunctions implements Callback<String> {

    public OnJSONResponseListener onJSONResponseListener;
    ...
    public JSONFunctions(OnJSONResponseListener ojrl) {
        this.onJSONResponseListener = ojrl;
    }
    ...
    public void makeHttpRequest(String url, String method, int url_no) {
        ...
        Log.d("SaloonApp", "URL ===> " + url);
        Log.d("SaloonApp", "PARAMS ===> " + hm);
    ...
    //for normal get and post for form data
    public void makeHttpRequest(String url, String getOrPostMethod, HashMap<String, String> hm, boolean isMultipart, int url_no) {
        // Making HTTP request
    ...
    // for normal get and post for raw data
    ...
    //for post method without body with header
    public void makeHeaderPOSTRequest(String url, int url_no, Context context) {
        Log.d(AppData.TAG, "URL ====> : "+ AppData.commonUrl  + url);
        ...
        SettingSharedPreferences ssp = new SettingSharedPreferences(context);
        headers.put("Authorization", "Bearer " + ssp.getUSERID());

        setupClientParams();


        RequestInterface apiService = retrofit.create(RequestInterface.class);
        Call<String> call = apiService.makeHeaderPostRequest(AppData.commonUrl + url, headers);
        if (call != null)
            call.enqueue(this);
        else {
            System.out.println("Something wrong, call is null");
    ...
    //for post method with body and header
    public void makeHeaderBodyPOSTRequest(String url, HashMap<String, String> hashMap, int url_no, Context context) {
        ...
        RequestInterface apiService = retrofit.create(RequestInterface.class);
        Call<String> call = apiService.makeHeaderBodyPostRequest(AppData.commonUrl + url, headers, hashMap);
        if (call != null)
            call.enqueue(this);
        else {
            System.out.println("Something wrong, call is null");
    ...
    public void onResponse(Call<String> call, Response<String> response) {
        ...
        Log.d("SaloonApp", "RESPONSE ===> " + strJson);

        onJSONResponseListener.getJSONResponseResult(strJson, url_no);
    }

    @Override
    public void onFailure(Call<String> call, Throwable t) {
        System.out.println("Inside onFailure, null will return");
        onJSONResponseListener.getJSONResponseResult(null, url_no);
    }

//    public void makeHeaderBodyPOSTRequest(String url, String post, HashMap<String, String> hashMap, boolean b, int profile_url) {
//    }
